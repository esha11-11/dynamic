            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                       ...
                       <a href="{{route('credit.customer')}}" target="_blank" class="btn btn-dark btn-rounded waves-effect waves-effect waves-light" style="float:right;"><i class="fas fa-print"> Back </i></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-end">{{$payment->payed_amount}}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3">    
                                             ...
                                             <div class="form-group col-md-3">  
                                                ...
                                                <input class="form-control  example-date-input" type="date" placeholder="YYYYY-MM-DD" 
                                                name="date" id="date"  >  
                                                </div>
                                            </div>
                                             ...
                                             <button type="sumbit" class="btn btn-info">Invoice Update</button>
                                            </div>
                                          </div>
                                        </div>
