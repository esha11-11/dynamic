                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Customer creditReport</li>
                        </ol>
                    </div>
                                    ...
                                    <div class="">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                        <td class="text-center"ss="text-center"> {{ $key+1}} </td>
                                                        <td class="text-center"> {{ $item['customer']['name'] }} </td> 
                                                        <td class="text-center"># {{ $item['invoice']['invoice_no'] }}  </td> 
                                                        <td class="text-center"> {{ date('d-m-Y',strtotime($item['invoice']['invoice_no']))}} </td> 
