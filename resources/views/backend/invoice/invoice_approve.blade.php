            ...
            <div class="card">
                <div class="card-body">
                    <h4>Invoice No: #{{ $invoice->invoice_no }} -
                     {{ date('d-m-Y',strtotime($invoice->date)) }}</h4>
                    <a href="{{route('invoice.pending.list')}}" class="btn btn-dark btn-rounded waves-effect waves-effect waves-light" style="float:right;"><i class="fas fa-list">Pending Invoice List</i></a>
                    <br><br>
                   <table class="table table-dark" width="100%">
                    ...
                    <form method="post" action="{{route('approval.store',$invoice->id) }}">
                       ...
                       <button type="sumbit" class="btn btn-info"> Invoice Approve </button>
                    </form>
